...
SECRET_KEY = 'django-insecure-rkd-1oguf0s_%b)m!75a4vo#p#rd48baq6)h#!k!x)@pfa7ize'
...
JAZZMIN_SETTINGS = {
    ...
    "search_model": "portfolio.Project",  # Default search in Projects

    # Sidebar Menu Order
    "order_with_respect_to": ["portfolio.PersonalDetail", "portfolio.Education", "portfolio.Skill", "portfolio.Project", "portfolio.ContactMessage"],

    # Model Icons
    "icons": {
        "portfolio.PersonalDetail": "fas fa-user",
    ...
    "topmenu_links": [
        ...
        {"name": "Visit Portfolio", "url": "/", "new_window": True},
    ],

    # UI Tweaks
    "changeform_format": "vertical_tabs",  # Tabbed layout for forms
